...
| `labelledBy`         | `labelled-by`         | Id of the element that labels the input, set as aria-labelledby.              | `string`                                                                                                                                                       | `undefined` |
...
| `value`              | `value`               | Current value of the input; also the value restored on form reset.            | `string`                                                                                                                                                       | `undefined` |
