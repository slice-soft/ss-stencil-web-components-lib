...
| `labelledBy`         | `labelled-by`         | Id of the element that labels the textarea, set as aria-labelledby.     | `string`                                                                                                                                         | `undefined`  |
...
| `value`              | `value`               | Current value of the textarea; also the value restored on form reset.   | `string`                                                                                                                                         | `undefined`  |
